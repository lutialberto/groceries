...
import { useThemeColor } from "../../hooks/themeColor/useThemeColor";
...
export default function InputTextApp<T extends FieldValues>({
  ...
  const { isMultiValue, isMaxLength, multiValueErrorMessage } = useMultiValue(
    field.value,
    maxMultivalue,
  );
    ...
    <View style={containerStyle}>
      ...
      <TextInput
        ...
        onSubmitEditing={(e) => {
          ...
          if (isMultiValue) {
            const isDuplicated = field.value.find(
              (v: string) => newValue === v,
            );
